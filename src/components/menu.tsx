  ...
  render() {
    ...
    return (
      <div className="menu-item">
        <div className={["menu-title", shouldLit ? "menu-title-lit" : "" ].join(" ")}>{title}</div>
        <div className="menu-bar">
          <svg className={["icon", shouldLit ? "icon-lit" : "" ].join(" ")} width="116" height="116" viewBox="0 0 116 116" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => onIconClick()}>
